      ...
      <div className="landing-page" style={{
        ...
        <section className="lp-section" id="lp-packages">
          ...
          <div className="lp-pkg-grid">
            {[
              ...
              {pkg:5,amt:160,desc:"Elite Ã‚Â· $160$5,120",feats:["Up to $2,355 direct","Elite network status","Maximum earnings","All bonuses unlocked"],hot:false},
          ...
          <div className="lp-rm-inner">
            ...
            <div className="lp-rm-track">
              ...
              <div className="lp-rm-items">
                {[
                  {icon:"Ã°Å¸Ââ€ºÃ¯Â¸Â",title:"C&B Platform",sub:"Community Building",tag:"done",label:"Live"},
                  {icon:"Ã°Å¸Âªâ„¢",title:"MGX Token",sub:"Token Launch",tag:"done",label:"Live"},
                  {icon:"Ã°Å¸ÂÂ¦",title:"MGX Staking",sub:"Stake & Earn Rewards",tag:"active",label:"In Progress"},
                  {icon:"Ã°Å¸Å½Â¨",title:"NFT Creation",sub:"NFT Minting Platform",tag:"soon",label:"Coming Soon"},
        ...
        <section className="lp-section" id="lp-features">
          ...
          <div className="lp-feat-grid">
            {[
              ["Ã°Å¸â€Â","UUPS Upgradeable Proxy","OpenZeppelin v5 with ERC-7201 namespaced storage. Contracts upgrade safely without disrupting user funds."],
              ...
              ["Ã¢â„¢Â»Ã¯Â¸Â","Rebirth mechanism","Complete Package 1 cycle and re-enter the network on the opposite side Ã¢â‚¬â€ unlocking a fresh income cycle."],
              ["Ã°Å¸â€™Å½","MGX staking rewards","Stake MGX tokens and earn 10.95% APY. Rewards distribute every 24 hours from the 10.23M MGX reward pool."],
